...
<body class="fixed-navbar">
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            <div class="page-heading">
                <h1 class="page-title">Usuarios Fiadores</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href=""><i class="la la-home font-20"></i></a>
                    </li>
                    <li class="breadcrumb-item">Usuarios Fiadores</li>
                </ol>
            </div>
            <?php require RUTA_APP . "/views/fiador/Content".".php"; ?>
    ...
    <script src=<?php echo RUTA_URL . "/js/pages/fiador/app.js";?> type="text/javascript"></script>
</body>
</html>