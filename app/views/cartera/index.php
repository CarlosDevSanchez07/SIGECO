...
<head>
    ...
    <!-- THEME STYLES-->
    <link href=<?php echo RUTA_URL . "/plugins/select2/dist/css/select2.min.css";?> rel="stylesheet" />
...
<body class="fixed-navbar">
        ...
        <div class="content-wrapper">
            <div class="page-heading">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Prestamos > Solicitar</li>
                </ol>
            </div>
            <?php require RUTA_APP . "/views/cartera/Content".".php"; ?>
    ...
    <script src=<?php echo RUTA_URL . "/js/pages/prestamos.solicitar/app.js";?> type="text/javascript"></script>
</body>
</html>