...
<body class="fixed-navbar">
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            <div class="page-heading">
                <h1 class="page-title">Usuarios Empleados</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href=""><i class="la la-home font-20"></i></a>
                    </li>
                    <li class="breadcrumb-item">Usuarios Empleados</li>
                </ol>
            </div>
            <?php require RUTA_APP . "/views/empleado/Content".".php"; ?>
    ...
    <script src=<?php echo RUTA_URL . "/js/pages/empleado/app.js";?> type="text/javascript"></script>
